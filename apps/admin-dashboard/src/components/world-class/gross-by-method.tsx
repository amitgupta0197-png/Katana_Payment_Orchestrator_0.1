...
export function GrossByMethod() {
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle className="text-base">Gross by payment method × banker</CardTitle>
        <CardDescription>Which method each banker collects through, by successful gross value.</CardDescription>
      </CardHeader>
      <CardContent>
        {q.isLoading ? (
