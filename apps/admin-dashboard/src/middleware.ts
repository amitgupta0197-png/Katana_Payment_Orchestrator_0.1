...
const PUBLIC_API = ["/api/auth/login", "/api/auth/logout", "/api/auth/me", "/api/health", "/api/openapi", "/api/pay", "/api/v1/katana-pay/order", "/api/v1/katana-pay/callback","/api/v1/poolpay/order", "/api/gateway/payu/return", "/api/gateway/payu/webhook", "/api/pay-result", "/api/v1/webhooks/payment-status", "/api/v1/txn-alert", "/api/v1/text-alert", "/api/v1/device/heartbeat", "/api/v1/device/email-config", "/api/v1/agent-debug", "/api/v1/capture-rrn", "/api/v1/cron/daily", "/api/v1/cron/status-sweep", "/api/v1/cron/email-poll", "/api/v1/cron/capture-health", "/api/v1/cron/payu-verify", "/api/v1/partner-inquiry", "/api/v1/telegram/webhook", "/api/v1/cron/telegram-daily", "/api/v1/reports/paytm-import"];
