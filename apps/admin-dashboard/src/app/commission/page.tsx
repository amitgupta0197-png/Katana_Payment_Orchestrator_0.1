  ...
  return (
    <>
      ...
      <DataView
        ...
        rowKey={(r) => r.id}
        loading={q.isLoading}
        search={{ placeholder: "Search by merchant id or rule kind…", fields: ["provider_id", "rule_kind"] }}
        filters={[
        ...
        emptyDescription="Add a rule (bps + fixed) per merchant to start accruing commission."
      />
    </>
  );
}
