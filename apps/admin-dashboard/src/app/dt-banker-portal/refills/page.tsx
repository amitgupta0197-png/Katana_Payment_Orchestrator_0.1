...
export default function BankerRefillsPage() {
  ...
  const q = useQuery({
    ...
    queryFn: async () => {
      const r = await fetch("/api/dt-banker-portal/refills");
  ...
  const create = useMutation({
    mutationFn: async () => {
      ...
      const r = await fetch("/api/dt-banker-portal/refills", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) });
