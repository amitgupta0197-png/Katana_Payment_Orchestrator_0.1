...
export default function PayinOrderPage() {
  ...
  return (
    <>
      <PageHeader title="Pay-in orders" description="All incoming order intake across bankers." icon={Receipt} />
      <DataView
        rows={rows}
        columns={cols}
        rowKey={(r) => r.id}
        ...
        search={{ placeholder: "Search by ref, txn, banker…", fields: ["client_ref", "txn_id", "merchant_id", "method"] }}
        filters={[
