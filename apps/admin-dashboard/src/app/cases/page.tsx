    ...
    <>
      ...
      <Card className="mb-4">
        ...
        <CardContent className="flex flex-wrap items-end gap-2">
          ...
          <Input className="h-9 w-40" placeholder="banker code" value={nc.merchant_id} onChange={(e) => setNc({ ...nc, merchant_id: e.target.value })} />
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-1">
            {cases.length === 0 && <EmptyState icon={Briefcase} title="No cases open" description="Open a case above to investigate a flagged order or banker — attach notes/evidence and place the order on hold." />}
            {cases.map((c) => (
