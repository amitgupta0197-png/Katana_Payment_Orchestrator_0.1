...
export default function FifoControlsPage() {
  ...
  return (
    <>
      <PageHeader title="Banker Controls" description="Transaction limits and approved line-of-business per banker (BRD FR-003, §11.A, §27)." icon={SlidersHorizontal} />
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2">
            <Input className="h-9" placeholder="banker code e.g. M10001" value={lim.merchant_id} onChange={(e) => setLim({ ...lim, merchant_id: e.target.value })} />
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Input className="h-9" placeholder="banker code" value={lob.merchant_id} onChange={(e) => setLob({ ...lob, merchant_id: e.target.value })} />
