// POST /api/merchant-portal/capture-rrn — raise an on-demand RRN capture request
...
//   PROVIDER / SUPER_ADMIN only (session-gated; middleware restricts /api/merchant-portal/*).
