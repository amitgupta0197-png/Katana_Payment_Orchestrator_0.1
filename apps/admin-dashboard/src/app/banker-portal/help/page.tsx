    ...
    <>
      ...
      <Card className="mb-4">
        ...
        <CardContent className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {[
            { href: "/banker-portal/api-keys", label: "Issue an API key", icon: KeyRound },
            { href: "/banker-portal/profile", label: "Configure webhooks", icon: Webhook },
            { href: "/banker-portal/sub-mids", label: "View / request Sub-MIDs", icon: CreditCard },
            { href: "/banker-portal/settlements", label: "Settlement statements", icon: Banknote },
          ].map((l) => {
            const Icon = l.icon;
            return (
      ...
      <Card className="mb-4">
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <p>You can change your password anytime under <Link href="/banker-portal/profile" className="text-[color:var(--color-brand)] underline">Profile → Change password</Link>.</p>
        </CardContent>
      </Card>
