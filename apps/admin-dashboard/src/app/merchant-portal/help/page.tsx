      ...
      <Card className="mb-4">
        ...
        <CardContent className="space-y-3 text-sm">
          <ol className="space-y-2">
            ...
            <Step n={2}>Pick the <strong>banker</strong> (from your mapped branches) and the <strong>Main MID</strong>, enter a <strong>Sub-MID code</strong>, and choose a <strong>mode</strong>.</Step>
