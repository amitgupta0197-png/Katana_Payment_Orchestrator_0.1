...
export default function ReservesPage() {
  ...
  return (
    <>
      <PageHeader title="Reserves" description="Rolling-reserve ledger across all bankers (PRODUCT_VISION §3.8)." icon={BookOpen} />
      ...
      <DataView
        ...
        rowKey={(r) => r.id}
        loading={q.isLoading}
        search={{ placeholder: "Search by banker…", fields: ["merchant_id"] }}
        filters={[
