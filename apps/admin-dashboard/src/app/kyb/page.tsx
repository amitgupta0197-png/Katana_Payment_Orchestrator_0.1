  ...
  return (
    <>
      ...
      <DataView
        ...
        loading={q.isLoading}
        href={(r) => `/kyb/${r.id}`}
        search={{ placeholder: "Search by banker id…", fields: ["merchant_id", "decided_by", "status"] }}
        filters={[
        ...
        emptyDescription="Cases open automatically when a banker reaches the SCREENING stage."
        rowActions={(r) => {
