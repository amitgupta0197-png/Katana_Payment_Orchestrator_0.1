      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <div className="flex items-center justify-between"><span className="text-[color:var(--color-text-muted)]">Banker</span><span className="font-mono">{dispute.merchant_id}</span></div>
