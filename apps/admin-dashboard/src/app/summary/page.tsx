...
export default function SummaryPage() {
  ...
  return (
    <>
      <PageHeader title="Summary" description="Platform-wide roll-up of pay-in volume by day + banker." icon={BarChart3} />
      ...
      <DataView rows={daily} columns={cols} rowKey={(r) => `${r.merchant_id}|${r.day}|${r.kind}|${r.status}|${r.currency}`} loading={q.isLoading}
        search={{ placeholder: "Search by banker / kind / status…", fields: ["merchant_id", "kind", "status"] }}
